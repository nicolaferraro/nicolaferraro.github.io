...
I eventually realized I was drifting too far into management, so I moved to **Red Hat**, where I could keep being an engineer. I joined as a senior engineer and later became principal. I got deep into Kubernetes and, together with a friend, created [Apache Camel K](https://github.com/apache/camel-k), a platform for running [Apache Camel](https://github.com/apache/camel) integrations on Kubernetes and OpenShift. I'm a committer and PMC member on Apache Camel, and I also worked on [Syndesis](https://syndesis.io) and the [Fabric8](https://github.com/fabric8io/fabric8) developer tools. Most of the posts here are from that period.
...
You can find me on [GitHub](https://github.com/nicolaferraro) and [LinkedIn](https://www.linkedin.com/in/nicolaferraro/). My full CV is on [LinkedIn](https://www.linkedin.com/in/nicolaferraro/).
