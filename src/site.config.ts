...
const config: SiteConfig = {
  ...
  site: 'https://www.nicolaferraro.me',
  ...
  tags: ['Apache Camel', 'Camel K', 'Kubernetes', 'Cloud Native', 'Integration', 'Serverless'],
  ...
  navLinks: [
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/nicolaferraro',
      external: true,
    },
  ],
  ...
  socialLinks: {
    github: 'https://github.com/nicolaferraro',
    linkedin: 'https://www.linkedin.com/in/nicolaferraro/',
  ...
  giscus: {
    repo: 'nicolaferraro/nicolaferraro.github.io',
    repoId: 'MDEwOlJlcG9zaXRvcnk2Njc3NTc2Mg==',
    category: 'Announcements',
    categoryId: 'DIC_kwDOA_rq0s4C-oxS',
