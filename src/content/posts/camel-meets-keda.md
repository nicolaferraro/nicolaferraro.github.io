...
description: 'Camel K integrations can leverage KEDA to scale based on the number of incoming events.'
tags: ['Apache Camel', 'Kamelets', 'Camel K', 'Kubernetes', 'Openshift', 'KEDA', 'JBoss Fuse']
coverImage:
  src: '../../assets/covers/post-logo-camel-keda.png'
  alt: 'Camel meets KEDA'
---
