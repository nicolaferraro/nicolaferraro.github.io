...
description: 'We''re starting a new initiative at Apache Camel to create a community-driven catalog of reusable Kamelets'
tags: ['Apache Camel', 'Kamelets', 'Camel K', 'Knative', 'Openshift', 'Kubernetes', 'Serverless', 'JBoss Fuse']
coverImage:
  src: '../../assets/covers/post-kamelet-catalog-featured.png'
  alt: 'Kamelet Catalog'
---
