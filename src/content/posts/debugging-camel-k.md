...
description: 'What if your Camel K integration does not work as expected? How do you debug it? Well, there''s a \"debug\" command now...'
tags: ['Apache Camel', 'Camel K', 'Knative', 'Openshift', 'Kubernetes', 'Serverless', 'JBoss Fuse']
coverImage:
  src: '../../assets/covers/post-logo-d.png'
  alt: 'Debugging Camel K'
---
