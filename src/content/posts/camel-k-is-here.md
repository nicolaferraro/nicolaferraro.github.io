...
coverImage:
  src: '../../assets/covers/post-logo-apache-camel-k-native.png'
  alt: 'Camel K 1.0 is here'
---
...
**NOTE:** this article has been first published on the [Apache Camel's Blog](https://camel.apache.org/blog/2020/06/camel-k-release-1.0.0/).
...
- Gitter: [https://gitter.im/apache/camel-k](https://gitter.im/apache/camel-k)
- GitHub: [https://github.com/apache/camel-k](https://github.com/apache/camel-k)
