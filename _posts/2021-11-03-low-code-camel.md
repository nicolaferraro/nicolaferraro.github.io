...
modified: 2021-11-03T02:00:00+02:00
last_modified_at: 2021-11-03T02:00:00+02:00
tags: [Apache Camel, Kamelets, Camel K, Kubernetes, Openshift, Knative, JBoss Fuse]
categories: [Dev]
excerpt: "How Kamelets enable a low code integration experience."
header:
    og_image: images/karavan-designer.png
    image: images/karavan-designer.png
    teaser: images/karavan-designer.png
---
...
While Camel K represented a fundamental shift towards a new approach to cloud-native integration, ["Kamelets"](/2020/10/12/kamelets/) are driving a deeper transformation towards "low code" development.
...
If you're a bit familiar with how [Kamelets](/2020/10/12/kamelets/) work, I think you've already got my point here.
...
on Kamelets. If you either need to create a simple source/sink integration or a more complex one, Karavan can help designing it with ease. There's also a [blog post about Karavan](https://camel.apache.org/blog/2021/10/camel-karavan-preview-release/) if you want to learn more.

![Karavan](/images/karavan.png)
*The Karavan UI*
...
an extended [Kamelet developer guide](https://camel.apache.org/camel-k/latest/kamelets/kamelets-dev.html) that covers
...
Kamelet developer guide contains a [section about an "Earthquake" source](https://camel.apache.org/camel-k/latest/kamelets/kamelets-dev.html#_step_5_wrap_it_into_a_kamelet) that is complicated on purpose, to mimic a Kamelet that may be developed for handling data inside an organization.
...
Then start playing with Karavan in combination with [Camel K](https://camel.apache.org/camel-k/latest/) and
the [Kamelet catalog](https://camel.apache.org/camel-kamelets/latest/).

And finally look at how easy is to [create and use your own Kamelets](https://camel.apache.org/camel-k/latest/kamelets/kamelets-dev.html).
